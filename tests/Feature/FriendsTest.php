...
class FriendsTest extends TestCase
{
   ...
   public function test_only_friend_request_can_be_accepted(){
        ...
        $response->assertJson([
            'errors' => [
                ...
                'detail' => 'Unable to locate the friend request  with the given infomation',
            ]
        ]);
   }
    ...
    public function test_a_friiend_id_required_for_friend_requests(){
    ...
    public function test_a_user_iid_and_status_is_required_for_friend_request_response(){
    ...
    public function test_a_friend_retrieved_when_fetching_the_profile() {
        $this->actingAs($user = factory(User::class)->create(), 'api');
    ...
    // 
    public function test_an_inverse_friendship_retrieved_when_fetching_the_profile() {
        $this->actingAs($user = factory(User::class)->create(), 'api');
